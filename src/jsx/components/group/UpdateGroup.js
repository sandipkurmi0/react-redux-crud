...
import { updateGroup } from "../../../stores/group/action";
...
const UpdateGroup = (props) => {
  ...
  const updateGroup = async () => {
    ...
    await props.updateGroup(state, id);
        ...
        <div className="w-full mx-auto space-y-6 bg-white border border-gray-200 shadow-lg rounded-xl">
          <div className="px-5 py-4 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-semibold text-gray-800">Edit Group</h2>
              </div>
              <div>
          ...
          <div className="p-3">
            <div className="overflow-x-auto">
              <TextInput
                ...
                label="Group Name"
                type="text"
                onchangeInput={(e) => setState({ ...state, groupName: e })}
                autofocus
                autocapitalize="off"
